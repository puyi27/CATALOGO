...
const demos = [
  ...
  { id: 'tienda', color: '#ec4899', nombre: 'ALTA JOYERÍA', path: '/demo/tienda', tags: ['ecommerce', 'lujo'], img: '/previews/tienda.jpg', fontClass: 'font-serif tracking-[0.25em]', styleDesc: 'Moda Editorial', explanation: 'Diagramación heredada de las revistas de moda. Imágenes en formato retrato y uso exhaustivo de tipografías Serif muy elegantes y refinadas.' },
