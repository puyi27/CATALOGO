...
const demos = [
  ...
  { id: 'tienda', color: '#f472b6', nombre: 'BOUTIQUE INFANTIL', path: '/demo/tienda', tags: ['ecommerce', 'infantil'], img: '/previews/tienda.jpg', fontClass: 'font-sans font-medium tracking-wide', styleDesc: 'Dulce y Alegre', explanation: 'Estética cálida y onírica. Paleta de colores empolvados (blanco nube, rosa palo, vainilla) con tipografías redondeadas que transmiten la magia y delicadeza de la moda infantil.' },
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute inset-0 z-10 pointer-events-none">
                      <div 
                        className="absolute top-1/2 left-1/2 w-[150%] h-[150%] opacity-0 group-hover:opacity-40 transition-all duration-1000 ease-out transform-gpu will-change-transform -translate-x-1/2 -translate-y-1/2 scale-100 group-hover:scale-125 group-hover:rotate-12"
                        style={{
                      ...
                      <div className="absolute inset-0 opacity-10 group-hover:opacity-30 transition-opacity duration-700 transform-gpu" 
