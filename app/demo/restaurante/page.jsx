...
const Nav = () => {
  ...
  return (
    ...
    >
      <Link href="/" className="flex items-center gap-2 uppercase tracking-widest text-xs hover:opacity-70 transition-opacity">
        <ArrowLeft size={16} /> Catálogo
      </Link>
      <div className="text-2xl font-serif tracking-[0.3em] uppercase">Aura</div>
      <button className="uppercase tracking-widest text-xs border border-white px-4 py-2 hover:bg-white hover:text-black transition-colors">
        Reservar
      </button>
    </motion.nav>
  )
  ...
  return (
    <section className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="z-10 text-center flex flex-col items-center">
        <h1 className="text-white text-7xl md:text-9xl font-serif tracking-[0.5em] md:tracking-[0.8em] uppercase ml-[0.5em] md:ml-[0.8em] overflow-hidden flex">
        ...
        <motion.p
          ...
          className="text-gray-400 mt-8 tracking-[0.3em] uppercase text-sm"
        >
...
const Experience = () => {
  ...
  return (
    <section className="relative w-full min-h-screen py-32 flex items-center justify-center bg-black overflow-hidden">
      ...
      <div className="z-10 w-full max-w-5xl px-6 flex flex-col items-center">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-gray-500 uppercase tracking-[0.4em] text-xs mb-24"
        >
          La Experiencia
        </motion.h2>
...
const Chef = () => {
  return (
    <section className="w-full min-h-screen bg-[#030303] flex flex-col md:flex-row items-center justify-center px-6 md:px-24 py-32 gap-16 lg:gap-32">
      <motion.div
      ...
      <div className="w-full md:w-6/12 flex flex-col justify-center">
        ...
        <motion.p
          ...
          className="mt-12 text-gray-500 uppercase tracking-[0.2em] text-sm"
        >
  ...
  return (
    <section ref={targetRef} className="relative h-[300vh] bg-black">
      <div className="sticky top-0 h-screen flex flex-col justify-center overflow-hidden">
        ...
        <motion.div style={{ x }} className="flex gap-12 md:gap-24 px-6 md:px-24 mt-20">
          {wines.map((wine, idx) => (
            <div key={idx} className="w-[85vw] md:w-[35vw] h-[60vh] shrink-0 relative group">
...
const Reservation = () => {
  return (
    <section className="w-full py-64 bg-[#030303] flex flex-col items-center justify-center text-center px-6 relative overflow-hidden">
      <motion.p
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="text-gray-400 uppercase tracking-[0.4em] text-sm mb-16"
      >
        Solo 12 comensales por noche.
      </motion.p>
      <MagneticButton>
        <button className="px-16 py-8 bg-white text-black font-serif text-2xl md:text-4xl uppercase tracking-widest hover:bg-gray-200 transition-colors">
          Solicitar Mesa
        </button>
      </MagneticButton>
    </section>
...
const Footer = () => {
  return (
    <footer className="w-full bg-black text-white py-16 border-t border-white/5 flex flex-col md:flex-row items-center justify-between px-12 md:px-24">
      <div className="font-serif text-3xl tracking-[0.3em] uppercase mb-8 md:mb-0 text-white/80">
        Aura
      </div>
...
export default function RestauranteDemo() {
  ...
  return (
    <main className="bg-black min-h-screen text-white font-sans selection:bg-white selection:text-black cursor-none">
      {isClient && (
        <motion.div
